  ...
  return (
    ...
    >
      {selectMode ? (
        ...
        <span className="text-xs text-muted-foreground/60 w-7 shrink-0 tabular-nums font-mono text-right">
          {solve.solve_number}.
        </span>
      )}
      <span
        className={cn(
          "font-mono text-base tabular-nums flex-1",
      ...
      >
        ...
        {isPlus2 && <span className="text-[11px] ml-0.5">+</span>}
      </span>
      {hasNotes && !selectMode && (
