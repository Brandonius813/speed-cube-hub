/**
 * Static list of all countries with ISO 3166-1 alpha-2 codes.
 * Used by the profile country picker so it never depends on the database.
 */
export type Country = {
  id: string   // ISO 3166-1 alpha-2 code (e.g., "US", "GB")
  name: string // Display name (e.g., "United States", "United Kingdom")
}
